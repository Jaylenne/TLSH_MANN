...
def preprocess_omniglot():
    ...
    num_labels = write_datafiles(directory, write_file, resize=True, rotate=True, new_width=IMAGE_NEW_SIZE,
                                 new_height=IMAGE_NEW_SIZE)

    directory = TEST_DIR
    write_file = DATA_FILE_FORMAT % 'test'
    write_datafiles(directory, write_file, resize=True, rotate=False, new_width=IMAGE_NEW_SIZE,
                    new_height=IMAGE_NEW_SIZE)
